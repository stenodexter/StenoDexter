  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      const { error } = await authClient.signUp.email({
        ...
        callbackURL: "/user",
        // phone and gender can be updated post-signup via a profile update call
        // if your better-auth setup supports additional fields, pass them here:
        // additionalFields: { phone: value.phone, gender: value.gender },
      });
            ...
            {(field) => (
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className={field.state.meta.errors[0] ? "border-destructive focus-visible:ring-destructive" : ""}
                />
